               ...
               <table class="table table-striped table-hover tabel-sm">
                   ...
                   ?>
                       <tr>
                           ...
                           <td><?= $data['jk']; ?></td>
                           <td><?= $data['alamat']; ?></td>
                           <td><a href="editdokter.php?edit=<?= $data['idDokter']; ?>" class="btn btn-warning btn-sm">Edit </a><a href="koneksi.php?idDokter=<?= $row['idDokter']; ?>" class="btn btn-danger btn-sm">Hapus</a></td>
                       </tr>
                   <?php } ?>
               </table>
           </div>
